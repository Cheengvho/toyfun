...
<style type="text/css">
	.orderInfoCol{border-top:1px solid #aaa; border-bottom:1px solid #aaa;}
			...
			<main id="main" class="site-main" role="main"> 
				...
				class="hero-slideshow-wrapper  hero-slideshow-normal">
					...
					<div class="container">
						<div class="row" style="margin-top:20px;">
							<h3 style="padding-left:20px; padding-bottom:10px; border-bottom:1px solid #aaa;">请填写以下信息</h3>
										...
										<div class="form-group col-md-6">
											<label>收货人</label>
											<input class="form-control" type="text" name="" value="" placeholder="收货人" >
										</div>
										<div class="form-group col-md-6">
											<label>联系电话</label>
											<input class="form-control" type="text" name="" value="" placeholder="联系电话" >
										</div>
										<div class="form-group col-md-6">
											<label>邮编</label>
											<input class="form-control" type="text" name="" value="" placeholder="邮编" >
										</div>
										<div class="form-group col-md-6">
											<label>城市</label>
											<input class="form-control" type="text" name="" value="" placeholder="城市" >
										</div>
										<div class="form-group col-md-12">
											<label>收货地址</label>
											<input class="form-control" type="text" name="" value="" placeholder="收货地址" >
										</div>
						</div>
						<div class="row">
							<h3 style="padding-left:20px; padding-bottom:10px; border-bottom:1px solid #aaa;">订单中商品</h3>
									<div class="media">
									  <div class="media-left">
									    <a href="#">
									      <img class="media-object" src="/res/images/1/1_800×800.jpg" alt="..." >
									    </a>
									  </div>
									  <div class="media-body">
									    <div class="col-md-6">
									    	<h4 class="media-heading">六子连芳</h4>
									    	<h5 class="media-heading"><span>种类：</span>鲁班锁</h5>
									    </div>
									    
									    <div class="col-md-6" style="height:120px; text-align:right;">
									    	<div><span>数量：</span><span >2</span></div>
									    	<div><span>单价：</span><span>12.00</span></div>
									    </div>
						...
						<div class="row" style="margin-top:20px; margin-bottom:20px;">
							...
							<div class="col-md-3">
								<table style="border:none;">
									<tr><th style="text-align:right; border:none;">总件数：</th><td>2</td></tr>
									<tr><th style="text-align:right; border:none;">总价：</th><td>24.00</td></tr>
						...
						<div class="row" style="margin-top:20px; margin-bottom:20px;">
							<div class="col-md-9"></div>
							<div class="col-md-3"><a href="#" class="btn btn-default btn-lg" style="margin-right:15px;">取消</a><input class="btn btn-primary" type="submit" value="提交订单"></div>
						</div>
