...
.orderTable tr td span.spanLineHeight {
	line-height: 60px;
}

.orderTable tr td span.spanLineHeightPL {
	line-height: 60px;
	padding-left: 15px;
}
.orderTable .productColspan .productColspanText{line-height:60px;}
		...
		<div id="content" class="site-content">
			...
			<div class="container" style="padding-top: 10%; padding-bottom: 10%;">
				<div class="hero__content hero-content-style1">
					<!-- 巨幕中间标题 -->
					<h2 class="hero-large-text">Orders Infomation</h2>
					<!-- 巨幕下方描述文字 -->
			...
			<div class="container">
				...
				<div class="row" style="margin-top: 20px;">
					<table class="table table-striped table-hover orderTable">
							...
							<tr>
								<td class="col-md-3"><span>订单号：</span><a href="/OrderInfo.jsp?o_id=${orderInfo.id }">${orderInfo.id }</a></td>
								<td class="col-md-5">${orderInfo.time }</td>
								<td class="col-md-1"><span>$${orderInfo.totalPrice }</span></td>
								<td class="tdFunction col-md-3" style="text-align: right;"><a href="/OrderInfo.jsp?o_id=${orderInfo.id }">查看订单</a><a href="#">取消订单</a><a href="#">删除订单</a></td>
							</tr>
							<c:forEach var="products" items="${products }">
								<tr class="productColspan">
									<td><a href="/ProductInfo.jsp?id=${products.id }"><img src="/res/images/goods/goods_main/${products.id }-800x800.jpg"></a></td>
