...
/**
 * Servlet implementation class ManageOrderInfo
 */
@WebServlet("/ManageOrderInfo.jsp")
public class ManageOrderInfo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/admin/manageOrderInfo.jsp").forward(request, response);
